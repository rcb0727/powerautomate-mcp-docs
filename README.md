...
|------|------------------|
| **README** (this page) | [Features](#features) · [Quick Start](#quick-start) · [App Registration](#microsoft-entra-app-registration) · [CLI Reference](#cli-reference) · [How It Works](#how-it-works) · [All 228 Tools](#available-tools-228-total) · [Security](#security) · [Architecture](#architecture) |
...
**228 tools, 24 groups — everything at a glance** (full list with descriptions: [Available Tools](#available-tools-228-total)):
